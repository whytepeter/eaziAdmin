<template>
  <div class="flex flex-col gap-4">
    <div class="flex items-center justify-between">
      <h2 class="text-xl">Payroll Transaction List</h2>
      <easiPaginate
        :data="transactions"
        info-only
    ...
    >
      ...
      <Column sortable field="emplyeesPaid" header=" No. Employees Paid" />

      <Column sortable field="amountPaid" header="Amount Paid">
        <template #body="slotProps">
          <div>
